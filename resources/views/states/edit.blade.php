			...
			<form method="POST" action="{{ url("states/$state->id") }}">
				...
				<select name="country_id" id="country_id">
					...
					@foreach ($countries as $country)
						...
						@if ( old('country_id', $state->country_id) == $country->id )
							...
							<option value="{{ old('country_id', $state->country_id)}}" >
								{{ $country->country }}
							</option>
				...
				<div class="input-group input-group-sm">
					...
					<div class="input-group-prepend">
				 	...
				 	<input type="text" name="iso" id="iso" placeholder="mir" value="{{ old('iso', $state->iso) }}"
				...
				<div class="input-group input-group-sm">
				 	...
				 	<input type="text" name="state" id="state" placeholder="miranda" value="{{ old('state', $state->state) }}"
				   class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
